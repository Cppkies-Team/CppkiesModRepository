...
const WelcomeNote: React.FC = React.memo(() => (
	<Frame style={{ textAlign: "center" }}>
		...
		(as the documention will be on Cppkies&apos; site, which is not updated
		yet), so maybe you can make an issue{" "}
		<a
		...
		<br />
		You can login with either Discord or Github to upload mods! There&apos;s no
		way to merge the accounts so that both log in to the same account, but that
		will be a thing!
		<br />
